    ...
    <div className="min-h-screen bg-gradient-to-tr from-[var(--primary,#2563eb)] via-[var(--accent,#9333ea)] to-pink-100 p-4 transition-colors">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {/* Card 1 */}
          <Link to="/khachhang" className="bg-white rounded-2xl shadow-xl p-7 flex flex-col items-center group hover:shadow-2xl transition cursor-pointer">
          ...
          {/* Card 2 */}
          <Link to="/dichvu" className="bg-white rounded-2xl shadow-xl p-7 flex flex-col items-center group hover:shadow-2xl transition cursor-pointer">
          ...
          {/* Card 3 */}
          <Link to="/nhanvien" className="bg-white rounded-2xl shadow-xl p-7 flex flex-col items-center group hover:shadow-2xl transition cursor-pointer">
          ...
          {/* Card 4 */}
          <Link to="/lichsu" className="bg-white rounded-2xl shadow-xl p-7 flex flex-col items-center group hover:shadow-2xl transition cursor-pointer">
