    ...
    <div className="min-h-screen bg-gradient-to-tr from-[var(--primary,#2563eb)] via-[var(--accent,#9333ea)] to-pink-100 p-4 transition-colors">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {/* Card 1 */}
          <a href="/khachhang" className="bg-white rounded-2xl shadow-xl p-7 flex flex-col items-center transition-transform hover:-translate-y-2 hover:shadow-2xl cursor-pointer group focus:outline-none focus:ring-2 focus:ring-[var(--primary,#2563eb)]" as="button" tabIndex={0}>
          ...
          {/* Card 2 */}
          <a href="/dichvu" className="bg-white rounded-2xl shadow-xl p-7 flex flex-col items-center transition-transform hover:-translate-y-2 hover:shadow-2xl cursor-pointer group focus:outline-none focus:ring-2 focus:ring-[var(--accent,#9333ea)]" as="button" tabIndex={0}>
          ...
          {/* Card 3 */}
          <div className="bg-white rounded-2xl shadow-xl p-7 flex flex-col items-center transition-transform hover:-translate-y-2 hover:shadow-2xl cursor-pointer group">
